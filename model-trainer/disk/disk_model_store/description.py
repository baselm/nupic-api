...
'/home/nupic/.local/lib/python2.7/site-packages/nupic/swarming/exp_generator/experiment_generator.pyc'
"""
...
control = {
  ...
  #
  'dataset' : {   u'info': u'disk',
        u'streams': [   {   u'columns': [u'*'],
                            u'info': u'disk.csv',
                            u'source': u'file://disk.csv'}],
        u'version': 1},
 ...
 u'predictedField': u'disk',
 u'predictionSteps': [1]},

  # Metrics: A list of MetricSpecs that instantiate the metrics that are
  # computed for this experiment
  'metrics':[
    MetricSpec(field=u'disk', metric='multiStep', inferenceElement='multiStepBestPredictions', params={'window': 1000, 'steps': [1], 'errorMetric': 'aae'}),
    MetricSpec(field=u'disk', metric='multiStep', inferenceElement='multiStepBestPredictions', params={'window': 1000, 'steps': [1], 'errorMetric': 'altMAPE'})
  ],
