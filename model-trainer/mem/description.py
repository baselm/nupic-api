...
control = {
  ...
  #
  'dataset' : {   u'info': u'mem',
        u'streams': [   {   u'columns': [u'*'],
                            u'info': u'mem.csv',
                            u'source': u'file://mem.csv'}],
        u'version': 1},
 ...
 u'predictedField': u'mem',
 u'predictionSteps': [1]},

  # Metrics: A list of MetricSpecs that instantiate the metrics that are
  # computed for this experiment
  'metrics':[
    MetricSpec(field=u'mem', metric='multiStep', inferenceElement='multiStepBestPredictions', params={'window': 1000, 'steps': [1], 'errorMetric': 'aae'}),
    MetricSpec(field=u'mem', metric='multiStep', inferenceElement='multiStepBestPredictions', params={'window': 1000, 'steps': [1], 'errorMetric': 'altMAPE'})
  ],
